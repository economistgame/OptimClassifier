...
<pre class="r"><code><span class="hljs-literal">linearcreditscoring</span> &lt;- <span class="hljs-keyword">Optim.LM</span>(Y~., AustralianCredit, p = <span class="hljs-number">0.7</span>, seed=<span class="hljs-number">2018</span>)</code></pre>
